...
test.args <- c('default' = '',
    ...
    'zerorevfitmarginnoautoexpand' = 'x.zero=TRUE, y.zero=TRUE, x.zero.line.color="red", y.zero.line.color="blue", fit.type = "Smooth", x.data.reversed=TRUE, y.data.reversed=TRUE, margin.autoexpand = FALSE',
    ...
    'tickdistnomarginautoexpand' = 'y.bounds.minimum=3, y.bounds.maximum=20, y.tick.distance=1, margin.autoexpand = FALSE',
